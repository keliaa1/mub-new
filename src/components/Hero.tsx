          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="flex flex-col items-center text-center -mt-20 px-4">
              <motion.span
                ...
                className="text-sm font-semibold text-white tracking-wider uppercase mb-4 px-4 py-1 bg-[#3c3b6e] rounded-full border dark:border-white/10 border-black/10"
              >
                {t('hero.badge')}
              </motion.span>
              ...
              >
                ...
                <button className="w-full sm:w-auto px-10 py-4 rounded-full border dark:border-white/20 border-black/20 dark:text-white text-slate-900 font-medium hover:dark:bg-white/10 bg-black/10 transition-all">
                  {t('hero.btn2')}
                </button>
              </motion.div>
            </div>
